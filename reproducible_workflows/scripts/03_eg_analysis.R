...
ctry_comp <- who_tb_data %>% # Lets compare TB cases in the youngest
  ...
  arrange(desc(most)) # Arrange the results in the table by highest to lowest
                      # number of cases recorded per year per country 

head(ctry_comp)

# Certainly a bad year by international standards for the Irish 0-14 year old cohort
